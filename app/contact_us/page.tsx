      ...
      <section className="py-32 bg-background">
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
            {/* Social Media */}
            <AnimatedSection>
              <div className="p-8 bg-card rounded-3xl border border-border h-full">
                ...
                <div className="flex gap-4">
                  <a
                    ...
                    className="flex items-center gap-3 px-6 py-4 bg-background rounded-2xl border border-border hover:border-primary/30 transition-all group"
                  >
              ...
              <div className="p-8 bg-card rounded-3xl border border-border h-full">
                ...
                <div className="mt-8 p-4 bg-muted rounded-xl">
                  <p className="text-sm text-muted-foreground">
                    <strong className="text-foreground">501(c)(3) Non-Profit:</strong> The DS
                    Standard Foundation is a registered non-profit organization. Contributions
                    by US citizens are tax-deductible.
                  </p>
                </div>
              </div>
            </AnimatedSection>
